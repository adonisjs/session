...
class Redis {
   ...
   */
  static get inject () {
    return ['Adonis/Src/Config', 'Adonis/Src/Helpers', 'Adonis/Addons/RedisFactory']
  }

  constructor (Config, Helpers, RedisFactory) {
     ...
     */
    this.redis = new RedisFactory(config, Helpers, false)
  }
